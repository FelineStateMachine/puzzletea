...
func TestWalkLine(t *testing.T) {
	tests := []struct {
		...
		{
			"horizontal line",
			game.Cursor{X: 0, Y: 0}, game.Cursor{X: 3, Y: 0},
			true,
			[]Position{{0, 0}, {1, 0}, {2, 0}, {3, 0}},
		},
		{
			"vertical line",
			game.Cursor{X: 2, Y: 0}, game.Cursor{X: 2, Y: 3},
			true,
			[]Position{{2, 0}, {2, 1}, {2, 2}, {2, 3}},
		},
		{
			"diagonal line",
			game.Cursor{X: 0, Y: 0}, game.Cursor{X: 2, Y: 2},
			true,
			[]Position{{0, 0}, {1, 1}, {2, 2}},
		},
		{
			"reverse diagonal",
			game.Cursor{X: 2, Y: 2}, game.Cursor{X: 0, Y: 0},
			true,
			[]Position{{2, 2}, {1, 1}, {0, 0}},
		},
		{
			"adjacent cells",
			game.Cursor{X: 0, Y: 0}, game.Cursor{X: 1, Y: 0},
			true,
			[]Position{{0, 0}, {1, 0}},
		},
		{
			"invalid line",
			game.Cursor{X: 0, Y: 0}, game.Cursor{X: 1, Y: 2},
			false,
			nil,
		},
		{
			"same point",
			game.Cursor{X: 1, Y: 1}, game.Cursor{X: 1, Y: 1},
			false,
			nil,
		},
	}
