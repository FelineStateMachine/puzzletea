...
func statusBarView(showFullHelp bool) string {
	if showFullHelp {
		return game.StatusBarStyle().Render("arrows/wasd: move  mouse: click/cycle  z/0: ●  x/1: ○  bkspc: clear  =: same clue  x: opposite clue  esc: menu  ctrl+r: reset  ctrl+h: help")
	}
	return game.StatusBarStyle().Render("mouse: click/cycle  z/0: ●  x/1: ○  fixed clues: = and x")
}
