...
var Modes = []game.Mode{
	...
	NewModeWithProfile(
		"Medium 7x7",
		"Mixed cage shapes with sparser anchors and roomier deductions.",
		7,
		4,
		0.50,
		generationProfile{
			cageWeights:       []int{0, 0, 3, 5, 4},
			frontierSamples:   2,
			shapeBias:         shapeBiasNeutral,
			minGivensByCage:   []int{0, 0, 0, 0, 0},
			maxSingletonCages: 1,
		},
	),
	NewModeWithProfile(
		"Hard 8x8",
		"Longer cages and sparse anchors reward broader ripple reads.",
		8,
		4,
		0.46,
		generationProfile{
			cageWeights:       []int{0, 0, 1, 4, 5},
			frontierSamples:   3,
	...
	NewModeWithProfile(
		"Expert 9x9",
		"Winding large cages and sparse anchors push global deductions.",
		9,
		5,
		0.42,
		generationProfile{
			cageWeights:       []int{0, 0, 1, 2, 4, 5},
			frontierSamples:   4,
			shapeBias:         shapeBiasWinding,
			minGivensByCage:   []int{0, 0, 0, 0, 0, 0},
			maxSingletonCages: 1,
		},
	),
}
